...
search_result <- fromJSON(content(query, "text"))
...
movie_returned <- names(search_result)
reviews <- names(search_result$results)


# Flatten the movie reviews content into a data structure called `reviews`
reviews <- flatten(search_result$results)
...
# Print out the list.
print(list(headline, short_summary, link))